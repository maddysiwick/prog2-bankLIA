...
public class StateManager {
        ...
        while(running){
            ...
            switch(reader.nextInt()){
                ...
                case 2:
                    ...
                    while(deciding){
                        System.out.println("what type of client are you?\n1- individual \n2- student\n3- corporate \n4- VIP");
                        System.out.print("> ");
                        switch(reader.nextInt()){
                            case 1:
            ...
            switch(reader.nextInt()){
                ...
                case 3:
                    ...
                    if(accountExists){
                        ...
                        System.out.print("> ");
                        try{
                            openAccount.transfer(reader.nextDouble(), transferAccount);
                            String transactionID=openAccount.getAccountNum()+r.nextInt(999999);
    ...
    private void updateAccounts(int monthsToCatchUp){
        if(monthsToCatchUp!=0){
            ...
            for(Account account:accounts.get("investment")){
    ...
    private void loadData(){
        ...
        try{
            File infoFile=new File("jsonFiles/openData.json");
    ...
    public HashMap<String,ArrayList<Client>> getClients() {
        return clients;
    }
    public void setClients(HashMap<String,ArrayList<Client>> clients) {
